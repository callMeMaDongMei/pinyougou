...
<!--页面顶部 开始-->
<#include "head.ftl"><#--引入外部分离ftl模板-->
<#assign imageList=goodsDesc.itemImages?eval><#--把图片json字符串转为json对象的集合-->
<#assign customAttributeList=goodsDesc.customAttributeItems?eval><#--把自定义拓展属性json字符串转为json对象的集合-->
<#assign specificationList=goodsDesc.specificationItems?eval><#--把规格列表json字符串转为json对象的集合-->
<!--页面顶部 结束-->
...
<#--规格选项-->    <div id="specification" class="summary-wrap clearfix">
